...
public final class FragmentSearchBinding implements ViewBinding {
  ...
  private FragmentSearchBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout noresultBg, @NonNull ProgressBar progressBarSearch2,
      @NonNull RecyclerView searchItemView2, @NonNull SearchView searchView2) {
  ...
  public static FragmentSearchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSearchBinding((ConstraintLayout) rootView, noresultBg, progressBarSearch2,
          searchItemView2, searchView2);
    }
